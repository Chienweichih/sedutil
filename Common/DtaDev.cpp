...
void DtaDev::discovery0()
{
    ...
    do {
        ...
        case FC_NSLocking:
            ...
            // FIXME: SWAP32()?
            disk_info.NSLocking_Max_Key_Count = body->Configurable_Namespace_LockingFeature.Max_Key_Count;
            disk_info.NSLocking_Unused_Key_Count = body->Configurable_Namespace_LockingFeature.Unused_Key_Count;
            disk_info.NSLocking_Max_Range_Per_NS = body->Configurable_Namespace_LockingFeature.Max_Range_Per_NS;
            break;
        default:
